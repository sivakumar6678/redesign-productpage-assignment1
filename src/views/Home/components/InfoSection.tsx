  ...
  return (
    <div className="scroll-smooth max-w-[1538px] mx-auto">
      <div className="w-full max-w-7xl mx-auto px-4 py-20 flex flex-col gap-y-20 md:gap-y-32">
        {/* ========== ABOUT US SECTION ========== */}
        <div className="flex flex-col lg:flex-row gap-8 items-center bg-white p-8 rounded-3xl shadow-sm hover:shadow-md transition-shadow">
          {/* Image Section */}
          <div className="w-full lg:w-1/2 flex items-center justify-center order-last lg:order-first">
            <img
              src={aboutUs}
              alt="About us"
              className="w-full object-cover rounded-xl max-w-[400px] border-4 border-white shadow-lg"
            />
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8">
              <div className="bg-blue-50 p-4 rounded-lg">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h4 className="font-semibold text-gray-800">Modern Solutions</h4>
                    <p className="text-sm text-gray-600">Leveraging AI technology for healthcare</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-blue-50 p-4 rounded-lg">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h4 className="font-semibold text-gray-800">Patient-Centric</h4>
                    <p className="text-sm text-gray-600">Personalized healthcare experiences</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        {/* ========== MISSION SECTION ========== */}
        <div className="flex flex-col lg:flex-row gap-8 items-center bg-gradient-to-r from-blue-50 to-purple-50 p-8 rounded-3xl">
          {/* Image Section */}
          <div className="w-full lg:w-1/2 flex items-center justify-center order-first lg:order-last">
            <img
              src={mission}
              alt="Our Mission"
              className="w-full object-cover rounded-xl max-w-md border-4 border-white shadow-lg"
            />
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8">
              <div className="bg-white p-4 rounded-lg shadow-sm">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h4 className="font-semibold text-gray-800">AI-Powered Solutions</h4>
                    <p className="text-sm text-gray-600">Optimizing operations with advanced technology</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white p-4 rounded-lg shadow-sm">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h4 className="font-semibold text-gray-800">Growth Focus</h4>
                    <p className="text-sm text-gray-600">Maximizing revenue and opportunities</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        {/* ========== CHALLENGES SECTION ========== */}
        <div className="flex flex-col lg:flex-row gap-8 items-center bg-[#01052f] text-white p-8 rounded-3xl">
          {/* Image Section */}
          <div className="w-full lg:w-1/2 flex items-center justify-center order-last lg:order-first">
            <img
              src={challenges}
              alt="Challenges in Medical Tourism"
              className="w-full object-cover rounded-xl max-w-[400px] border-4 border-white/10 shadow-lg"
            />
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8">
              <div className="bg-white/10 p-4 rounded-lg backdrop-blur-sm">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h4 className="font-semibold text-white">Efficient Operations</h4>
                    <p className="text-sm text-gray-300">Streamlined booking and management</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white/10 p-4 rounded-lg backdrop-blur-sm">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h4 className="font-semibold text-white">Enhanced Support</h4>
                    <p className="text-sm text-gray-300">Improved patient communication</p>
                  </div>
                </div>
              </div>
            </div>
